...
class BasicBlock(nn.Module):
    ...
    def __init__(self,
        ...
        # Both self.conv1 and self.shortcut layers shortcut the input when stride != 1
...
class Bottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        # Both self.conv2 and self.shortcut layers shortcut the input when stride != 1
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        if quantize:
            ...
            self.conv1 = nn.Conv2d(3, self.inplanes, kernel_size=kernel, stride=stride, padding=padding, bias=False)
        ...
        if quantize:
            self.linear = quant_nn.QuantLinear(512 * block.expansion, num_classes)
        else:
    ...
    def _make_layer(self,
        ...
        layers = []
        layers.append(
            block(self.inplanes, planes, stride, shortcut, self.groups, self.base_width, previous_dilation,
